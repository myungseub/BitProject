...
<%--  <c:if test="${login.uid == bugger1VO.price1}"> --%>
<%--  </c:if> --%>
    <button type="submit" class="btn btn-warning" id="modifyBtn">Modify</button>
  </div>
</form>
    <button type="submit" class="btn btn-primary" id="goListBtn">GO LIST </button>
<%--     	<c:out value = "${bugger1VO.tab1}"/> --%>
...
<%--     <a href="/sbugger1/removePage?bugger1No=${bugger1VO.bugger1No}"><button type="submit" class="btn btn-danger" id="delbtn">REMOVE</button></a> --%>
...
// 		formObj.attr"/sbugger1/removePage?bugger1No=${bugger1VO.bugger1No}"
...
// 		formObj.attr("action", "/sbugger1/removePage");
// 		formObj.submit();
// 				   }
		   });
...
// 				formObj.submit();				
// 			});
// 			$.post("/deleteFile",{files:arr}, function(){
// 				formObj.attr("action", "/sbugger1/removePage");
// 				formObj.submit();				
// 			});
// 		}else{
